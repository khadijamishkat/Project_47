...
function spawnObstaclesBottom(){
  if(World.frameCount % 60 === 0){
    ...
    switch(rand){
      case 1: obstacleBottom.addImage(obsBottom1Img)
              break
      case 2: obstacleBottom.addImage(obsBottom2Img)
              break
      case 3: obstacleBottom.addImage(obsBottom3Img)
      default: break
    }
